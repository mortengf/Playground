using MyCoreWebAPI.Application.Common.Models;
using MyCoreWebAPI.Application.TodoItems.Commands.CreateTodoItem;
using MyCoreWebAPI.Application.TodoItems.Commands.DeleteTodoItem;
using MyCoreWebAPI.Application.TodoItems.Commands.UpdateTodoItem;
using MyCoreWebAPI.Application.TodoItems.Commands.UpdateTodoItemDetail;
using MyCoreWebAPI.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace MyCoreWebAPI.Web.Endpoints;
